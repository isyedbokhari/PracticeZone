...
public class Task01 {
		/*
		 * Write a program that can verify if a password 
		 * is a strong password. Characteristics of strong 
		 * passwords are: 1.1 Password must be at least 
		 * have 8 characters long, and should not contain 
		 * space 1.2 PassWord should at least contain one 
		 * upper case letter 1.3 PassWord should at least 
		 * contain one lower case letter 1.4 Password 
		 * should at least contain one special characters
